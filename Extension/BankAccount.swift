...
public class BankAccount {
    public class func allAccounts() -> [INPaymentAccount] {
        return [
            ...
            INPaymentAccount(nickname: INSpeakableString(spokenPhrase: "Standard Account"), number: "******333", accountType: .debit, organizationName: INSpeakableString(spokenPhrase: "Standard Bank"), balance: INBalanceAmount(amount: 9462.93, currencyCode: "SGD"),secondaryBalance: nil)
        ]
    }
}
